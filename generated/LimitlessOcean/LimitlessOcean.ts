...
export class LimitlessOcean__getListingResultValue0Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class LimitlessOcean extends ethereum.SmartContract {
  static bind(address: Address): LimitlessOcean {
    return new LimitlessOcean("LimitlessOcean", address);
  }

  getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): LimitlessOcean__getListingResultValue0Struct {
    ...
    return changetype<LimitlessOcean__getListingResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getListing(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<LimitlessOcean__getListingResultValue0Struct> {
    ...
    return ethereum.CallResult.fromValue(
      changetype<LimitlessOcean__getListingResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
